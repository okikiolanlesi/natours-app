...
})(
  {
          ...
          P = (e) => {
            return (
              ...
              (('function' == typeof FormData && e instanceof FormData) ||
                ...
                (b(e.toString) && '[object FormData]' === e.toString()))
            );
          },
          S = s('URLSearchParams'),
          B = (e) =>
      ...
      function (require, module, exports) {
        ...
        Object.assign(h.prototype, {
          ...
          toJSON: function (e) {
            ...
            return (
              t.default.forEach(
                Object.assign({}, this[s] || null, this),
                (r, s) => {
                  null != r &&
                    !1 !== r &&
                    (n[s] = e && t.default.isArray(r) ? r.join(', ') : r);
                }
              ),
              n
            );
          ...
          Object.assign(h, {
            from: function (n) {
              return t.default.isString(n)
                ? new this((0, e.default)(n))
                : n instanceof this
                ? n
                : new this(n);
            },
        ...
        function E(c) {
          return new Promise(function (p, E) {
            ...
            if (
              ...
              (q.onerror = function () {
                E(new u.default('Network Error', u.default.ERR_NETWORK, c, q)),
                  (q = null);
              }),
            ...
            x && -1 === d.default.protocols.indexOf(x)
              ? E(
                  new u.default(
        ...
        function d() {
          ...
          return (
            'undefined' != typeof XMLHttpRequest
              ? (r = f.default.getAdapter('xhr'))
              : void 0 !== e &&
                'process' === t.default.kindOf(e) &&
                (r = f.default.getAdapter('http')),
            r
          );
        }
        function p(e, r, a) {
        ...
        const c = {
          ...
          transformRequest: [
            function (e, r) {
              ...
              if (
                (f && t.default.isHTMLForm(e) && (e = new FormData(e)),
                t.default.isFormData(e))
              )
                return o && o ? JSON.stringify((0, s.default)(e)) : e;
              if (
                t.default.isArrayBuffer(e) ||
                t.default.isBuffer(e) ||
                t.default.isStream(e) ||
                t.default.isFile(e) ||
                t.default.isBlob(e)
              )
                return e;
              if (t.default.isArrayBufferView(e)) return e.buffer;
              if (t.default.isURLSearchParams(e))
                return (
                  r.setContentType(
              ...
              if (f) {
                if (a.indexOf('application/x-www-form-urlencoded') > -1)
                  return (0, n.default)(e, this.formSerializer).toString();
                if (
                  (u = t.default.isFileList(e)) ||
              ...
              return f || o
                ? (r.setContentType('application/json', !1), p(e))
                : e;
            },
          ],
          transformResponse: [
                ...
                try {
                  ...
                  if (t) {
                    if ('SyntaxError' === o.name)
                      throw r.default.from(
                        o,
                        r.default.ERR_BAD_RESPONSE,
                        this,
                        null,
                        this.response
                      );
          ...
          maxBodyLength: -1,
          env: {
            FormData: o.default.classes.FormData,
            Blob: o.default.classes.Blob,
          },
          ...
          return (
            ...
            (s.adapter || a.default.adapter)(s).then(
              function (r) {
                return (
                  o(s),
                  (r.data = e.default.call(s, s.transformResponse, r)),
                  (r.headers = t.default.from(r.headers)),
                  r
                );
              },
              function (a) {
                return (
                  (0, r.default)(a) ||
                    ...
                    a &&
                      ...
                      (a.response.headers = t.default.from(
                        a.response.headers
                      )))),
                  Promise.reject(a)
                );
    ...
    Qj6T: [
      function (require, module, exports) {
        ...
        function n(t, n) {
          ...
          function r(i) {
            return e.default.isUndefined(n[i])
              ? e.default.isUndefined(t[i])
                ? void 0
                : o(void 0, t[i])
              : o(t[i], n[i]);
          }
      ...
      function (require, module, exports) {
        ...
        class d {
          ...
          request(t, r) {
            ...
            const d =
              r.headers &&
              e.default.merge(r.headers.common, r.headers[r.method]);
            d &&
              e.default.forEach(
            ...
            this.interceptors.request.forEach(function (e) {
              ('function' == typeof e.runWhen && !1 === e.runWhen(r)) ||
                ((c = c && e.synchronous), f.unshift(e.fulfilled, e.rejected));
            });
            const h = [];
            let p;
          ...
          function E(t, r, e) {
            ...
            return function (o, i) {
              ...
              for (e.method = o, e.arg = i; ; ) {
                ...
                if ('normal' === u.type) {
                  if (
                    ((n = e.done ? 'completed' : 'suspendedYield'), u.arg === p)
                  )
                    continue;
                  return { value: u.arg, done: e.done };
                }
      ...
      function (require, module, exports) {
        ...
        function o() {
          ...
          return (
            ...
            i(d, 'constructor', { value: y, configurable: !0 }),
            (y.displayName = l(d, s, 'GeneratorFunction')),
            (t.isGeneratorFunction = function (t) {
            ...
            (t.mark = function (t) {
              return (
                Object.setPrototypeOf
                  ? Object.setPrototypeOf(t, d)
                  : ((t.__proto__ = d), l(t, s, 'GeneratorFunction')),
                  ...
                  for (;;)
                    switch ((r.prev = r.next)) {
                      ...
                      case 7:
                        (r.prev = 7),
                          (r.t0 = r.catch(0)),
                          (0, e.showAlert)('error', r.t0.response.data.message);
                      case 10:
                      case 'end':
                        return r.stop();
                    }
      ...
      function (require, module, exports) {
        ...
        function o() {
          ...
          function E(t, e, r) {
            ...
            return function (o, i) {
              ...
              for (r.method = o, r.arg = i; ; ) {
                ...
                if ('normal' === c.type) {
                  if (
                    ((n = r.done ? 'completed' : 'suspendedYield'), c.arg === p)
                  )
                    continue;
          ...
          return (
            ...
            (v.displayName = f(y, s, 'GeneratorFunction')),
            (t.isGeneratorFunction = function (t) {
              var e = 'function' == typeof t && t.constructor;
              return (
                !!e &&
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        'success' === (i = e.sent).data.status &&
                          window.location.replace(
                            i.data.transaction.data.authorization_url
                          ),
                          (e.next = 10);
                        break;
                      case 7:
    ...
    Focm: [
      function (require, module, exports) {
        ...
        var e = require('./signup'),
          r = require('./login'),
          t = require('./mapbox.js'),
          s = require('./updateSettings.js'),
          o = n(require('./payStack.js'));
        function n(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function u(e) {
        ...
        function i() {
          ...
          function d(e, r, t, o) {
            var n = r && r.prototype instanceof f ? r : f,
              u = Object.create(n.prototype),
              i = new k(o || []);
            return s(u, '_invoke', { value: x(e, t, i) }), u;
          }
          function m(e, r, t) {
            try {
          ...
          function x(e, r, t) {
            ...
            return function (o, n) {
              ...
              for (t.method = o, t.arg = n; ; ) {
                ...
                if ('normal' === c.type) {
                  if (
                    ((s = t.done ? 'completed' : 'suspendedYield'), c.arg === j)
                  )
                    continue;
                  return { value: c.arg, done: t.done };
                }
                'throw' === c.type &&
                  ((s = 'completed'), (t.method = 'throw'), (t.arg = c.arg));
              }
            };
          }
          function E(e, r) {
            ...
            (k.prototype = {
              ...
              finish: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                  ...
                  if (t.finallyLoc === e)
                    return this.complete(t.completion, t.afterLoc), S(t), j;
                }
              },
              catch: function (e) {
                for (var r = this.tryEntries.length - 1; r >= 0; --r) {
        ...
        var l = document.getElementById('map'),
          ...
          m = document.querySelector('.signUpForm'),
          j = document.querySelector('.nav__el--logout'),
          f = document.querySelector('.form-user-data'),
          p = document.querySelector('.form-user-settings'),
          h = document.getElementById('bookTour');
        d &&
          ...
          m &&
            m.addEventListener('submit', function (r) {
              r.preventDefault();
