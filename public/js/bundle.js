        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User signed up successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === 'success') {
              // alerts the user that they have successfully logged in and redirects them to the home page
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2tpa2lvbGFubGVzaSIsImEiOiJjbGFiNzY3ZzUwYnlhM29uMDZ4aWgxbm16In0.mlAkpZrGvpY74vI9gBwkGw';
...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var bookButton = document.getElementById('bookTour');
// DELEGATION
// if (mapbox) {
